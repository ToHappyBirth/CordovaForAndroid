package com.msh.toastdemo.android.utils;
...
public class SunmiPrintHelper {
    ...
    /**
     * init print_success print service
     */
    ...
    /**
     * deInit print_success print service
     */
     ...
     * Sample print receipt
     */
    public void printFoodSample(JSONObject jsonObject) {
        if (sunmiPrinterService == null) {
            //TODO Service disconnection processing
            return;
        }
        ...
        JSONObject jsonForm = jsonObject.optJSONObject("form");
        ...
        for (int i = 0; i < jsonArray.length(); i++) {
            ...
            try {
                ...
                sunmiPrinterService.printerInit(null);
                sunmiPrinterService.setAlignment(1, null);
                sunmiPrinterService.printText(title, null);
                if (paper == 1) {
                    sunmiPrinterService.printText("--------------------------------\n", null);
                } else {
                    sunmiPrinterService.printText("------------------------------------------------\n",
                ...
                String txts[] = new String[]{"key", "value"};
                ...
                txts[0] = jsonForm.optString("formfood");
                txts[1] = jsonObj.optString("foodname");
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                txts[0] = jsonForm.optString("formmeal");
                txts[1] = jsonObj.optString("meal");
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                txts[0] = jsonForm.optString("formweight");
                txts[1] = jsonObj.optString("weight");
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                txts[0] = jsonForm.optString("formtime");
                txts[1] = jsonObj.optString("time");
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                txts[0] = jsonForm.optString("formoperator");
                txts[1] = jsonObj.optString("operator");
                sunmiPrinterService.printColumnsString(txts, width, align, null);
                if (paper == 1) {
                    sunmiPrinterService.printText("--------------------------------\n", null);
                } else {
